...
<style>
    ...
    * { box-sizing:border-box; }
    ...
    .form-group input { padding:10px 12px; border-radius:8px; border:1px solid #d1d5db; font-size:15px; }
    .form-group input:focus { outline:none; border-color:#1d4ed8; box-shadow:0 0 0 2px rgba(29,78,216,0.2); }
...
<div class="wrap">
    ...
    <p class="subtitle">Update the details of this customer</p>
    ...
    <div class="form-container">
        <form method="post" action="<%=request.getContextPath()%>/CustomerController">
            ...
            <div class="form-group">
                ...
                <input type="text" name="accountNumber" id="accountNumber" value="<%= customer.getAccountNumber() %>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phoneNumber" id="phoneNumber" value="<%= customer.getPhoneNumber() %>" required>
            </div>
            <div class="form-group">
            ...
            <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:20px;">
                <a href="<%=request.getContextPath()%>/CustomerController?action=list" class="btn btn-danger">Cancel</a>
...
<script>
    ...
    function confirmLogout(){
        return confirm("Log out from the staff session?");
    }
</script>
</body>
</html>

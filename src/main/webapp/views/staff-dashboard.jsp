...
<div class="wrap">
    ...
    <div class="topbar">
        ...
        <div class="right">
            <div class="userbox">
                ...
                <div class="badge">
                    <%= (user.getRole() != null ? user.getRole().substring(0,1).toUpperCase() + user.getRole().substring(1) : "Staff") %>
                </div>
            </div>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <a class="go" href="<%=request.getContextPath()%>/BillController?action=list">Go Forward →</a>
        </div>

...
<head>
<meta charset="UTF-8">
<title>Pahana edu — Add Product</title>
    ...
    <div class="form-container">
        <form method="post" action="ProductController">
            ...
            <div class="form-group">
                ...
                <input type="text" name="product_code" id="code" required placeholder="Enter product code">
            </div>
...
<script>
    ...
    // Optional: show toast if message present

...
<div class="wrap">
    ...
    <div class="subtitle">Manage all customers in the billing system</div>

    <!-- Actions -->
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap;">
        <a href="CustomerController?action=new" class="btn-success">+ Add New Customer</a>
        <div class="search-box">
            <input type="text" id="searchInput" class="search-input" placeholder="Search by name or account number...">
        </div>
    </div>
    ...
    <table id="customerTable">
        ...
        %>
            <tr>
                ...
                <td><%= c.getEmail() %></td>
                <td class="actions">
                    <form method="get" action="CustomerController" style="display:inline;">
                    ...
                    <form method="get" action="CustomerController" style="display:inline;" onsubmit="return confirmDelete()">
...
<script>
    ...
    function confirmLogout(){ return confirm("Log out from the staff session?"); }
    ...
    document.getElementById("searchInput").addEventListener("keyup", function() {
        ...
        rows.forEach(row => {
            ...
            if(name.includes(filter) || account.includes(filter)) row.style.display="";
